...
- (void) finishedUpdatingPoints: (NSObject *) arrayOrDictionary{
    ...
    NSString *creatorName =  [payloadDictionary objectForKey:@"creator"];
    currentPayloadString = [payloadDictionary objectForKey:@"key"];
    ...
    if (payload == nil) {
        ...
        [[self view] bringSubviewToFront:creatorLabel];
        [[self view] bringSubviewToFront:flagButton];
    }
